...
class Test_FooterCard:
    ...
    def test_footer_card_box_value(self):
        ...
        card = footer_card()
        # Assert
        assert card.box == 'footer', "Expected 'footer' but got something else"
    ...
    def test_footer_card_caption_value(self):
        ...
        card = footer_card()
        # Assert
        assert card.caption == 'Made with 💛 and H2O Wave.', "Expected 'Made with 💛 and H2O Wave.' but got something else"
    ...
    def test_footer_card_return_type(self):
        ...
        card = footer_card()
        # Assert
        assert isinstance(card, ui.footer_card), "Expected type 'ui.footer_card' but got something else"
