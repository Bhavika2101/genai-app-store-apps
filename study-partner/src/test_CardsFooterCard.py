...
Validation:
  Rationalize: The footer_card function is expected to return an object of type 'ui.footer_card'. This test ensures that the function is returning the correct object type.
```
"""
...
class Test_CardsFooterCard:
    ...
    def test_footer_card_box_value(self):
        ...
        card = footer_card()
        # Assert
        assert card.box == 'footer', "The box value of the footer card is not 'footer'"
    ...
    def test_footer_card_caption_value(self):
        ...
        card = footer_card()
        # Assert
        assert card.caption == 'Made with 💛 and H2O Wave.', "The caption of the footer card is not 'Made with 💛 and H2O Wave.'"
    ...
    def test_footer_card_return_type(self):
        ...
        card = footer_card()
        # Assert
        assert isinstance(card, ui.footer_card), "The returned object is not of type 'ui.footer_card'"
